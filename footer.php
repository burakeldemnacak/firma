		<footer class="short" id="footer">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-5">
							<a href="index.php">
										<img alt="<?php echo  $ayarcek['ayar_logo']; ?>" width="250" height="75" data-sticky-width="100" data-sticky-height="80" data-sticky-top="70" src="<?php echo  $ayarcek['ayar_logo']; ?>">
									</a>
						...
						<div class="col-md-3 col-md-offset-1">
							...
							<ul class="list list-icons mt-xl">
								<li><i class="fa fa-map-marker"></i> <strong>Adres : </strong><?php echo $ayarcek['ayar_adres']; ?> <br> <?php echo $ayarcek['ayar_ilce']; ?> <br><?php echo $ayarcek['ayar_il']; ?>
		...
		<!-- Google Analytics: Change UA-XXXXX-X to be your site's ID. Go to http://www.google.com/analytics/ for more information.'UA-12345678-1-->
		<script>

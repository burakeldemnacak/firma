...
if (isset($_POST['genelayarkaydet'])) {
	...
	$ayatkaydet=$db->prepare("UPDATE ayar SET 
	...
	$update=$ayatkaydet->execute(array(
...
if (isset($_POST['Mailayarkaydet'])) {
	...
	$ayatkaydet=$db->prepare("UPDATE ayar SET 
		...
		ayar_smtpuser=:smtpuse,
		ayar_smtppassword=:smtppassword,
		ayar_smptport=:smtpport
		WHERE ayar_id=1"); 
	$update=$ayatkaydet->execute(array(
		'smtphost' => $_POST['ayar_smtphost'],
		'smtpuse'=>$_POST['ayar_smtpuser'],
		'smtppassword' => $_POST['ayar_smtppassword'],
		'smtpport' => $_POST['ayar_smptport']
		));
...
if (isset($_POST['hakkimizdakaydet'])) {
	...
	$ayatkaydet=$db->prepare("UPDATE hakkimizda SET 
...
if (isset($_POST['sliderkaydet'])) {
	...
	$kaydet=$db->prepare("INSERT slider set
		slider_ad=:ad,
		slider_link=:link,
		slider_sira=:sira,
		slider_durum=:durum,
...
if (isset($_POST['icerikkaydet'])) {
	...
	$resimyol=$_POST['icerik_resimyol'];
	


	$kaydet=$db->prepare("INSERT icerik set
		icerik_ad=:ad,
...
if (isset($_POST['menukaydet'])) {
	...
	$kaydet=$db->prepare("INSERT menu set
		menu_ust=:ust,
		menu_ad=:ad,
		menu_url=:url,
		menu_detay=:detay,
...
$kullanici_password=md5($_POST['kullanici_password']);
	$ayatkaydet=$db->prepare("UPDATE kullanici SET 

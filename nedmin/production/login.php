...
<html lang="en">
  <head>
    ...
    <title>BEN Yazılım Burakeldemnacak Yönetim Paneli | </title>
            ...
            <form action="../netting/islem.php" method="POST">
              ...
              if ($_GET['durum']=="no") {
               ...
               ?>
                ...
                <div>
                  <h1><i class="fa fa-paw"></i>Burakeldemncak</h1>
                  <p>©2017  Burakeldemnacak! Tarafından yapılmıştır</p>
                </div>
              </div>
            </form>
          </section>

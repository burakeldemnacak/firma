          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kullanıcı Profil İşlemleri <small>
                      <?php 
                      if($_GET['durum']=='ok') {?>
...
<img width="150"  src="../../ims/profil.jpg" >
<?php } ?>                         
                ...
                <input type="hidden" name="yeni_yol" value=" <?php echo $kullanicicek['kullanici_resim']; ?> ">
...
<br>
                  <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kuallanıcı Şifre<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">

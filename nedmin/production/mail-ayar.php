                  ...
                  <div class="x_content">
                   ...
                   <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" placeholder="Smtp Port Numarınızı Giriniz.." name="ayar_smptport" value="<?php echo $ayarcek['ayar_smptport']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

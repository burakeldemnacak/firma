				...
				<div class="container">
					<div class="row pt-xl">
						<div class="col-md-7">
							...
							<p class="lead mb-xl mt-lg">Bize Buradan Ulasa Bilirsiniz</p>
<div class="divider divider-primary divider-small mb-xl">
						...
						<div class="col-md-4 col-md-offset-1">
							...
							<h4 class="mt-xl mb-none">İletişim</h4>
							<div class="divider divider-primary divider-small mb-xl">
								<hr>
							</div>
							...
							<ul class="list list-icons list-icons-style-3 mt-xlg mb-xlg">
								...
								<li><i class="fa fa-phone"></i> <strong>Telefon:</strong> <?php echo $ayarcek['ayar_gsm']; ?></li>
								<li><i class="fa fa-mobile" aria-hidden="true"></i> <strong>Cep Telefon:</strong> <?php echo $ayarcek['ayar_tel']; ?></li
								<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <?php echo $ayarcek['ayar_mail']; ?></li>
							</ul>
...
<iframe
  width="100%"
  height="100%"
  frameborder="0" style="border:0" id="harita"
  src="https://www.google.com/maps/embed/v1/place?key=<?php echo $ayarcek['ayar_goooglemap']; ?>&q= <?php echo $ayarcek['ayar_adres']; ?>" allowfullscreen>
</iframe>
